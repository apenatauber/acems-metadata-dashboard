...
```{r}
# use benzoic acid data to get uncertainty in T at the end; assume it's the same
# throughout

end_t_BA <- benzoic_acid %>%
  filter(time > ms("50:00"))
variance_t <- var(end_t_BA$temperature)
variance_t
```